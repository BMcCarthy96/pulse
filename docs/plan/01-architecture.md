...
Key decisions and the _why_ (these appear in the README later — keep them honest):

| Decision                                                                  | Rationale                                                                                                                                     |
| ------------------------------------------------------------------------- | --------------------------------------------------------------------------------------------------------------------------------------------- |
| Separate worker service (not Vercel functions)                            | Long-running consumers, repeatable jobs, and backoff timers don't fit serverless timeouts. This separation _is_ one of the portfolio signals. |
